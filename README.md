...
4. Установить нужные зависимости командой npm i.
5. Запустить приложение командой npm start.

При работе через mock-сервер недоступен функционал связанный с POST запросами, а также отключена авторизация.
